...
public abstract class AbstractPoddArtifactManagerTest
{
    ...
    public void setUp() throws Exception
    {
        ...
        // begin: INSIDE extractPurlReferences
        ...
        for(final PoddPurlProcessorFactory nextProcessorFactory : testArtifactManager.getPurlManager()
                .getPurlProcessorFactoryRegistry().getByStage(PoddProcessorStage.RDF_PARSING))
        {
            ...
            while(queryResult.hasNext())
            {
                ...
                // NOTE: Predicate rewriting is not supported. Predicates in OWL Documents must
                // be URIs from recognise vocabularies, so cannot be autogenerated PURLs
        ...
        // end: INSIDE extractPurlReferences
