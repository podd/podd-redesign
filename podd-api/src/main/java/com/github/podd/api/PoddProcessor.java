 ...
 * 
 */
public interface PoddProcessor<I>
{
    /**
     ...
     */
    void handleAfter(PoddProcessorEvent<I> event);
    
    /**
     * Called if this processor is being used as a handler for the stage that is about to be
     * started.
     * 
     * @param stage
     *            The stage that is about to be started.
     */
    void handleBefore(PoddProcessorEvent<I> event);
}
