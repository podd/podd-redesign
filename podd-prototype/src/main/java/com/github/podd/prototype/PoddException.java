...
/**
 * This class extends <code>java.lang.Exception</code> to provide a 
 * PODD specific exception class.
 * 
 * @author kutila
 *
 */
public class PoddException extends Exception {
	 ...
	 * @param details An object containing details of the underlying cause.
	 * @param code A numeric code describing the Exception.
	 */
	public PoddException(String msg, Object details, int code) {
		super(msg);
