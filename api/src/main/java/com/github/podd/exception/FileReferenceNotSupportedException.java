...
/**
 * An exception that is thrown to indicate that validating a particular {@link FileReference} 
 * is not supported by the FileRepository configuration which threw this Exception.
 * 
 * @author kutila
 */
public class FileReferenceNotSupportedException extends PoddException
{
    ...
    public FileReferenceNotSupportedException(final FileReference fileReference, final String msg, final Throwable throwable)
    {
        super(msg, throwable);
        this.fileReference = fileReference;
    }
