 ...
 * @author kutila
 */
public class DataReferenceNotSupportedException extends PoddException
{
    ...
    public DataReferenceNotSupportedException(final DataReference dataReference, final String msg)
    {
        super(msg);
    ...
    public DataReferenceNotSupportedException(final DataReference dataReference, final Throwable throwable)
    {
        super(throwable);
        this.dataReference = dataReference;
    }
