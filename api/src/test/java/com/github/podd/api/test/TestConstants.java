...
public interface TestConstants
{
    ...
    public static final int TEST_ARTIFACT_BASIC_1_INTERNAL_OBJECT_INFERRED_TRIPLES = 325;
    ...
    public static final int TEST_ARTIFACT_BASIC_PROJECT_2_INFERRED_TRIPLES = 319;
    ...
    public static final int TEST_ARTIFACT_BASIC_PROJECT_PUBLISHED_INFERRED_TRIPLES = 319;
    ...
    public static final int TEST_ARTIFACT_IMPORT_PSCIENCEv1_INFERRED_TRIPLES = 325;
    ...
    public static final int TEST_ARTIFACT_NO_VERSION_INFO_INFERRED_TRIPLES = 325;
    ...
    public static final int TEST_ARTIFACT_PURLS_v1_INFERRED_TRIPLES = 319;
    ...
    public static final int TEST_ARTIFACT_WITH_REFERSTO_INFERRED_TRIPLES = 551;
