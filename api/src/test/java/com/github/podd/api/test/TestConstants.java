...
public interface TestConstants
{
    ...
    public static final int EXPECTED_TRIPLE_COUNT_PODD_SCIENCE_INFERRED = 210;
    
    public static final int EXPECTED_TRIPLE_COUNT_PODD_PLANT_CONCRETE = 214;
    public static final int EXPECTED_TRIPLE_COUNT_PODD_PLANT_INFERRED = 356;
    ...
    public static final int TEST_ARTIFACT_BASIC_1_INTERNAL_OBJECT_INFERRED_TRIPLES = 327;
    ...
    public static final int TEST_ARTIFACT_BASIC_PROJECT_2_INFERRED_TRIPLES = 321;
    ...
    public static final int TEST_ARTIFACT_BASIC_PROJECT_PUBLISHED_INFERRED_TRIPLES = 321;
    ...
    public static final int TEST_ARTIFACT_IMPORT_PSCIENCEv1_INFERRED_TRIPLES = 327;
    ...
    public static final int TEST_ARTIFACT_NO_VERSION_INFO_INFERRED_TRIPLES = 327;
    ...
    public static final int TEST_ARTIFACT_PURLS_v1_INFERRED_TRIPLES = 321;
    ...
    public static final int TEST_ARTIFACT_BASIC_1_20130206_INFERRED_TRIPLES = 559;
    ...
    public static final int TEST_ARTIFACT_WITH_REFERSTO_INFERRED_TRIPLES = 553;
