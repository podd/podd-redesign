...
public interface TestConstants
{
    ...
    public static final int EXPECTED_TRIPLE_COUNT_PODD_BASE_CONCRETE = 346;
    public static final int EXPECTED_TRIPLE_COUNT_PODD_BASE_INFERRED = 71;
    
    public static final int EXPECTED_TRIPLE_COUNT_PODD_SCIENCE_CONCRETE = 1368;
    public static final int EXPECTED_TRIPLE_COUNT_PODD_SCIENCE_INFERRED = 212;
    
    public static final int EXPECTED_TRIPLE_COUNT_PODD_PLANT_CONCRETE = 214;
    public static final int EXPECTED_TRIPLE_COUNT_PODD_PLANT_INFERRED = 362;
    ...
    public static final int TEST_ARTIFACT_BASIC_1_INTERNAL_OBJECT_INFERRED_TRIPLES = 331;
    ...
    public static final int TEST_ARTIFACT_BASIC_PROJECT_2_INFERRED_TRIPLES = 325;
    ...
    public static final int TEST_ARTIFACT_BASIC_PROJECT_PUBLISHED_INFERRED_TRIPLES = 325;
    ...
    public static final int TEST_ARTIFACT_IMPORT_PSCIENCEv1_INFERRED_TRIPLES = 331;
    ...
    public static final int TEST_ARTIFACT_NO_VERSION_INFO_INFERRED_TRIPLES = 331;
    ...
    public static final int TEST_ARTIFACT_PURLS_v1_INFERRED_TRIPLES = 325;
    ...
    public static final int TEST_ARTIFACT_BASIC_1_20130206_INFERRED_TRIPLES = 563;
    ...
    public static final int TEST_ARTIFACT_WITH_REFERSTO_INFERRED_TRIPLES = 557;
