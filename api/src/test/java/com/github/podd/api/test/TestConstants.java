...
public interface TestConstants
{
    ...
    public static final int EXPECTED_TRIPLE_COUNT_PODD_BASE_CONCRETE = 360;
    ...
    public static final int EXPECTED_TRIPLE_COUNT_PODD_SCIENCE_INFERRED = 207;
    
    public static final int EXPECTED_TRIPLE_COUNT_PODD_PLANT_CONCRETE = 243;
    public static final int EXPECTED_TRIPLE_COUNT_PODD_PLANT_INFERRED = 345;
    ...
    public static final int TEST_ARTIFACT_BASIC_1_INTERNAL_OBJECT_INFERRED_TRIPLES = 316;
    ...
    public static final int TEST_ARTIFACT_BASIC_PROJECT_2_INFERRED_TRIPLES = 310;
    ...
    public static final int TEST_ARTIFACT_BASIC_PROJECT_PUBLISHED_INFERRED_TRIPLES = 310;
    ...
    public static final int TEST_ARTIFACT_IMPORT_PSCIENCEv1_INFERRED_TRIPLES = 316;
    ...
    public static final int TEST_ARTIFACT_NO_VERSION_INFO_INFERRED_TRIPLES = 316;
    ...
    public static final int TEST_ARTIFACT_PURLS_v1_INFERRED_TRIPLES = 310;
