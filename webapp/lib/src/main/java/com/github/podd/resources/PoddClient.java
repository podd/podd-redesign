...
import com.github.podd.utils.InferredOWLOntologyID;
	...
	public interface PoddClient
	{
	    ...
	    InferredOWLOntologyID appendArtifact(InferredOWLOntologyID ontologyId, InputStream partialInputStream,
	            RDFFormat format) throws PoddException;
	    
	    InferredOWLOntologyID appendArtifact(InferredOWLOntologyID ontologyId, InputStream partialInputStream,
	            RDFFormat format, DanglingObjectPolicy danglingObjectPolicy,
	            DataReferenceVerificationPolicy dataReferenceVerificationPolicy) throws PoddException;
	     ...
	     * @throws PoddClientException
	     */
	    PoddUser createUser(PoddUser user) throws PoddException;
	     ...
	     */
	    boolean deleteArtifact(InferredOWLOntologyID ontologyId) throws PoddException;
	     ...
	     *             If an error occurred.
	     */
	    Model doSPARQL(String queryString, Collection<InferredOWLOntologyID> artifacts) throws PoddException;
	     ...
	     */
	    Model downloadArtifact(InferredOWLOntologyID artifactId) throws PoddException;
	     ...
	     */
	    Model getObjectByURI(URI object, Collection<InferredOWLOntologyID> artifacts) throws PoddException;
	     ...
	     *             If there is an exception while executing the query.
	     */
	    Model getObjectsByType(URI type, Collection<InferredOWLOntologyID> artifacts) throws PoddException;
	     ...
	     *             If there is an exception while executing the query.
	     */
	    Model getObjectsByPredicate(URI predicate, Collection<InferredOWLOntologyID> artifacts) throws PoddException;
	    ...
	    Model getObjectsByTypeAndParent(URI parent, URI parentPredicate, URI type,
	            Collection<InferredOWLOntologyID> artifacts) throws PoddException;
	     ...
	     * @throws PoddClientException
	     */
	    Map<RestletUtilRole, Collection<String>> listRoles(InferredOWLOntologyID artifactId) throws PoddException;
	     ...
	     * @throws PoddClientException
	     */
	    Map<RestletUtilRole, Collection<URI>> listRoles(String userIdentifier) throws PoddException;
	     ...
	     */
	    List<PoddUser> listUsers() throws PoddException;
	     ...
	     */
	    boolean login(String username, String password) throws PoddException;
	     ...
	     */
	    boolean logout() throws PoddException;
	     ...
	     */
	    InferredOWLOntologyID publishArtifact(InferredOWLOntologyID ontologyId) throws PoddException;
	     ...
	     */
	    InferredOWLOntologyID unpublishArtifact(InferredOWLOntologyID ontologyId) throws PoddException;
	     ...
	     */
	    InferredOWLOntologyID uploadNewArtifact(InputStream input, RDFFormat format) throws PoddException;
	     ...
	     *         IRI to determine if there have been changes to the ontology in future.
	     */
	    InferredOWLOntologyID uploadNewArtifact(Model model) throws PoddException;
	     ...
	     */
	    boolean autologin() throws PoddException;
	    
	    Model getObjectsByTypeAndBarcode(URI type, String barcode, Collection<InferredOWLOntologyID> artifacts)
	        throws PoddException;
	    
	    Model getObjectsByBarcode(String barcode, Collection<InferredOWLOntologyID> artifacts) throws PoddException;
	}
