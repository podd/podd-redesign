...
public interface TestConstants
{
    ...
    public static final int EXPECTED_TRIPLE_COUNT_PODD_BASE_CONCRETE = 347;
    public static final int EXPECTED_TRIPLE_COUNT_PODD_BASE_INFERRED = 71;
    
    public static final int EXPECTED_TRIPLE_COUNT_PODD_SCIENCE_CONCRETE = 1259;
    ...
    public static final int EXPECTED_TRIPLE_COUNT_PODD_PLANT_INFERRED = 341;
    ...
    public static final int TEST_ARTIFACT_BASIC_1_INTERNAL_OBJECT_INFERRED_TRIPLES = 312;
    ...
    public static final int TEST_ARTIFACT_BASIC_PROJECT_2_INFERRED_TRIPLES = 306;
    ...
    public static final int TEST_ARTIFACT_BASIC_PROJECT_PUBLISHED_INFERRED_TRIPLES = 306;
    ...
    public static final int TEST_ARTIFACT_IMPORT_PSCIENCEv1_INFERRED_TRIPLES = 312;
    ...
    public static final int TEST_ARTIFACT_NO_VERSION_INFO_INFERRED_TRIPLES = 312;
    ...
    public static final int TEST_ARTIFACT_PURLS_v1_INFERRED_TRIPLES = 306;
    ...
    public static final int TEST_ARTIFACT_BASIC_1_20130206_INFERRED_TRIPLES = 551;
